        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-16">
          <div className="flex-1 space-y-6 text-center md:text-left animate-fade-in">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              ...
              <span className="block text-2xl md:text-3xl lg:text-4xl mt-2 text-white font-medium">
                Feito por fãs, para fãs
              </span>
            </h1>

            <p className="text-lg md:text-xl text-white font-medium max-w-2xl">
              Receba resultados, escalações, próximos jogos e muito mais
              diretamente no <span className="highlight-text">Telegram</span>.
            </p>
